    ...
    return (
        ...
        >
          ...
          <div className='w-[78.7vw] mt-6'>
            <h2 className='text-[22px]'>Announcement</h2>
             <Table className='mt-2'>
                <TableHead>
                    <TableRow style={{backgroundColor:'#342'}}>
                      <TableCell style={{fontWeight:'bold', fontSize:'16px', color:'white'}}>#</TableCell>
                      <TableCell style={{fontWeight:'bold', fontSize:'16px', color:'white'}}>Name</TableCell>
                      <TableCell style={{fontWeight:'bold', fontSize:'16px', color:'white'}}>Created By</TableCell>
                      <TableCell style={{fontWeight:'bold', fontSize:'16px', color:'white'}}>Date</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    <TableRow>
                        <TableCell>1</TableCell>
                        <TableCell><Link to='' className='text-blue-400 cursor-pointer'>Important Announcement</Link></TableCell>
                        <TableCell>Administrator</TableCell>
                        <TableCell>19-05-2025 13:20:58</TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell>2</TableCell>
                        <TableCell><Link to='' className='text-blue-400 cursor-pointer'>Public Holiday</Link></TableCell>
                        <TableCell>Administrator</TableCell>
                        <TableCell>19-05-2025 13:20:58</TableCell>
                    </TableRow>
                </TableBody>

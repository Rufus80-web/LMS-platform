...
import { deleteEventApi, getEventApi } from "../../api/teacher.api";
...
const DisplayEvent: FC = () => {
  ...
  const handleEventDelete = async () => {
    try {
      ...
      const response = await deleteEventApi(teacherId, eventID as string);
      ...
      if (status === "error") {
        ...
        setTimeout(() => route("/teacher/event-management"), 2000);
      }
    } catch (err: any) {
    ...
    <div className="w-screen min-h-screen flex select-none">
      ...
      >
        ...
        >
          ...
          <div className="pl-1">
            <DashHeader
              title="Event Detailed Information"
              message={event.title}
            />
            ...
            >
              ...
              <section className="grid grid-cols-3 items-center">
                <div className="flex flex-col gap-3 w-60 h-15">
                  ...
                  <span>
                    {event.teacherId?.gender === "Male" ? 'M' : 'Mme'} &nbsp;
                ...
                <div className="flex flex-col gap-3 w-60 h-15">
                  ...
                  <div className="flex flex-col gap-3 w-60 h-15">
                    <span>Status:</span>
                    <span>{event.hasPassed ? "Written" : "Upcomming"}</span>
                  </div>
              </section>
              <hr className="mt-3 border-[#85838336] border-solid border-1" />
              <section className="mt-4 flex gap-4">
                <Button
                  ...
                  onClick={() => route("/teacher/edit-event/" + eventID)}
                >
                  Edit
                </Button>
                <Button

...
export const getOneCourse = (courseId: string) => API.get(`${BASE_REQUEST_URL}/get-course?courseId=${courseId}`)
...
// export const adminProfileUpdate = (id: string, data) => API.put(`${BASE_REQUEST_URL}/user/update/${id}`, data)
